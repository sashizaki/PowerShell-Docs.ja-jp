...
コマンドレット名では使用できませんの特殊文字の一覧は、次を参照してください。[必要な開発ガイドライン](./required-development-guidelines.md)します。
...
動詞に関するガイドラインの詳細については、次を参照してください。[コマンドレット動詞名](./approved-verbs-for-windows-powershell-commands.md)します。 コマンドレット名では使用できませんの特殊文字の一覧は、次を参照してください。[必要な開発ガイドライン](./required-development-guidelines.md)します。
