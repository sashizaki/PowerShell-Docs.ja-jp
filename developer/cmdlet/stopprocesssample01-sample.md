...
3. <span data-ttu-id="05ae4-110">**ビルド**メニューの **ソリューションのビルド**します。</span><span class="sxs-lookup"><span data-stu-id="05ae4-110">In the **Build** menu, select **Build Solution**.</span></span>
