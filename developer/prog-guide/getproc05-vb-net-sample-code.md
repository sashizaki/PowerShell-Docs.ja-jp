---
title: GetProc05 (VB.NET) サンプル コード |Microsoft Docs
ms.custom: ''
ms.date: 09/13/2016
ms.reviewer: ''
ms.suite: ''
...
ms.locfileid: "56853508"
---
# <a name="getproc05-vbnet-sample-code"></a><span data-ttu-id="faea1-102">GetProc05 (VB.NET) サンプル コード</span><span class="sxs-lookup"><span data-stu-id="faea1-102">GetProc05 (VB.NET) Sample Code</span></span>

<span data-ttu-id="faea1-103">GetProc05 サンプル コマンドレットの完全な VB.NET コードを次に示します。</span><span class="sxs-lookup"><span data-stu-id="faea1-103">Here is the complete VB.NET code for the GetProc05 sample cmdlet.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="faea1-104">参照</span><span class="sxs-lookup"><span data-stu-id="faea1-104">See Also</span></span>

[<span data-ttu-id="faea1-105">Windows PowerShell SDK</span><span class="sxs-lookup"><span data-stu-id="faea1-105">Windows PowerShell SDK</span></span>](../windows-powershell-reference.md)