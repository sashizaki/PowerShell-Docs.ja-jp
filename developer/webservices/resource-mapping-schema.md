---
title: リソースのスキーマ マッピング |Microsoft Docs
ms.custom: ''
ms.date: 09/12/2016
ms.reviewer: ''
ms.suite: ''
...
ms.locfileid: "56862698"
---
# <a name="resource-mapping-schema"></a><span data-ttu-id="d9bf2-102">リソース マッピング スキーマ</span><span class="sxs-lookup"><span data-stu-id="d9bf2-102">Resource Mapping Schema</span></span>

<span data-ttu-id="d9bf2-103">Management OData IIS 拡張機能では、XML ファイルを使用して、リソースのマッピングを定義します。</span><span class="sxs-lookup"><span data-stu-id="d9bf2-103">Management OData IIS Extension uses XML files to define resource mapping.</span></span> <span data-ttu-id="d9bf2-104">次の XSD では、これらのファイルで使用されるスキーマを定義します。</span><span class="sxs-lookup"><span data-stu-id="d9bf2-104">The following XSD defines the schema used for these files.</span></span>

## <a name="resource-mapping-file-xsd"></a><span data-ttu-id="d9bf2-105">マッピングの XSD リソース ファイル</span><span class="sxs-lookup"><span data-stu-id="d9bf2-105">Resource Mapping File XSD</span></span>

<span data-ttu-id="d9bf2-106">次の XSD では、Management OData IIS 拡張機能リソースのマッピング ファイルのスキーマを定義します。</span><span class="sxs-lookup"><span data-stu-id="d9bf2-106">The following XSD defines the schema for Management OData IIS Extension resource mapping files.</span></span>
