...
ms.locfileid: "62080562"
---
# <a name="resource-mapping-schema"></a><span data-ttu-id="7c668-102">リソース マッピング スキーマ</span><span class="sxs-lookup"><span data-stu-id="7c668-102">Resource Mapping Schema</span></span>

<span data-ttu-id="7c668-103">Management OData IIS 拡張機能では、XML ファイルを使用して、リソースのマッピングを定義します。</span><span class="sxs-lookup"><span data-stu-id="7c668-103">Management OData IIS Extension uses XML files to define resource mapping.</span></span> <span data-ttu-id="7c668-104">次の XSD では、これらのファイルで使用されるスキーマを定義します。</span><span class="sxs-lookup"><span data-stu-id="7c668-104">The following XSD defines the schema used for these files.</span></span>

## <a name="resource-mapping-file-xsd"></a><span data-ttu-id="7c668-105">マッピングの XSD リソース ファイル</span><span class="sxs-lookup"><span data-stu-id="7c668-105">Resource Mapping File XSD</span></span>

<span data-ttu-id="7c668-106">次の XSD では、Management OData IIS 拡張機能リソースのマッピング ファイルのスキーマを定義します。</span><span class="sxs-lookup"><span data-stu-id="7c668-106">The following XSD defines the schema for Management OData IIS Extension resource mapping files.</span></span>
