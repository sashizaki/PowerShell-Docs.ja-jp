...
| 概念 | 詳細情報
|-|-
| 部分構成 | [ドキュメント](partialconfigs.md)
| 複合リソース | [ドキュメント](authoringresourcecomposite.md)
...
チーム B から変更が必要な場合は、チーム A のソース管理環境に対してプル要求を送信する必要があります。
...
リリース パイプラインを使用して、コア インフラストラクチャを管理する方法の詳細については、ホワイト ペーパー「[The Release Pipeline Model (リリース パイプライン モデル)](http://aka.ms/thereleasepipelinemodel)」を参照してください。
