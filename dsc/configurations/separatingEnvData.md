...
<span data-ttu-id="6d908-112">簡単な例で仕組みを見てみましょう。</span><span class="sxs-lookup"><span data-stu-id="6d908-112">Let's look at a very simple example to see how this works.</span></span>
