...
## Description
LocalGroup コマンドレットは、ローカルセキュリティグループの名前を **変更** します。
...
このコマンドは、SecurityGroup という名前のセキュリティグループの名前を変更します。

## PARAMETERS

### -InputObject
このコマンドレットの名前を変更するセキュリティグループを指定します。
...
### -Name
このコマンドレットの名前を変更するセキュリティグループの名前を指定します。
...
### -SID
このコマンドレットの名前を変更するセキュリティグループのセキュリティ ID (SID) を指定します。
