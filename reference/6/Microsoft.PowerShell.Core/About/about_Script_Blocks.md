...
<span data-ttu-id="acf1d-141">遅延をパラメーターとして **バインド** するスクリプトブロックに関する注意事項:</span><span class="sxs-lookup"><span data-stu-id="acf1d-141">Notes on **delay-bind** script blocks as parameters:</span></span>
