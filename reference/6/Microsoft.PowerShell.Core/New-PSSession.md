...
### <span data-ttu-id="3131e-109">Uri</span><span class="sxs-lookup"><span data-stu-id="3131e-109">Uri</span></span>
...
## <span data-ttu-id="3131e-115">Description</span><span class="sxs-lookup"><span data-stu-id="3131e-115">DESCRIPTION</span></span>
...
## <span data-ttu-id="3131e-131">例</span><span class="sxs-lookup"><span data-stu-id="3131e-131">EXAMPLES</span></span>
...
### <span data-ttu-id="3131e-156">例 6: 別のドメイン内のグローバルスコープを持つセッションを作成する</span><span class="sxs-lookup"><span data-stu-id="3131e-156">Example 6: Create a session with a global scope in a different domain</span></span>
...
### <span data-ttu-id="3131e-180">例 10: URI を使用してコンピューターのセッションを作成する</span><span class="sxs-lookup"><span data-stu-id="3131e-180">Example 10: Create a session for a computer by using its URI</span></span>
...
### <span data-ttu-id="3131e-193">例 13: SSH を使用してセッションを作成し、ポートとユーザー認証キーを指定する</span><span class="sxs-lookup"><span data-stu-id="3131e-193">Example 13: Create a session using SSH and specify the port and user authentication key</span></span>
...
### <span data-ttu-id="3131e-217">-認証</span><span class="sxs-lookup"><span data-stu-id="3131e-217">-Authentication</span></span>
...
### <span data-ttu-id="3131e-232">-CertificateThumbprint</span><span class="sxs-lookup"><span data-stu-id="3131e-232">-CertificateThumbprint</span></span>
...
### <span data-ttu-id="3131e-270">-ContainerId</span><span class="sxs-lookup"><span data-stu-id="3131e-270">-ContainerId</span></span>
...
<span data-ttu-id="3131e-295">このパラメーターは、PowerShell 3.0 で導入されました。</span><span class="sxs-lookup"><span data-stu-id="3131e-295">This parameter was introduced in PowerShell 3.0.</span></span>
...
<span data-ttu-id="3131e-304">このパラメーターは、PowerShell 6.0 で導入されました。</span><span class="sxs-lookup"><span data-stu-id="3131e-304">This parameter was introduced in PowerShell 6.0.</span></span>
...
<span data-ttu-id="3131e-313">別のポートを使用する前に、そのポートでリッスンするようにリモートコンピューター上の WinRM リスナーを構成する必要があります。</span><span class="sxs-lookup"><span data-stu-id="3131e-313">Before using another port, you must configure the WinRM listener on the remote computer to listen at that port.</span></span> <span data-ttu-id="3131e-314">リスナーを構成するには、次のコマンドを使用します。</span><span class="sxs-lookup"><span data-stu-id="3131e-314">Use the following commands to configure the listener:</span></span>
...
<span data-ttu-id="3131e-362">WS-Management は、ネットワーク経由で送信されるすべての PowerShell コンテンツを暗号化します。</span><span class="sxs-lookup"><span data-stu-id="3131e-362">WS-Management encrypts all PowerShell content transmitted over the network.</span></span> <span data-ttu-id="3131e-363">**UseSSL** パラメーターは、HTTP 接続ではなく HTTPS 接続を介してデータを送信する追加の保護を提供します。</span><span class="sxs-lookup"><span data-stu-id="3131e-363">The **UseSSL** parameter offers an additional protection that sends the data across an HTTPS connection instead of an HTTP connection.</span></span>
...
<span data-ttu-id="3131e-381">リモートコンピューター上のユーザーを認証するために Secure Shell (SSH) によって使用されるキーファイルパスを指定します。</span><span class="sxs-lookup"><span data-stu-id="3131e-381">Specifies a key file path used by Secure Shell (SSH) to authenticate a user on a remote computer.</span></span>
...
### <span data-ttu-id="3131e-390">-UserName</span><span class="sxs-lookup"><span data-stu-id="3131e-390">-UserName</span></span>
...
<span data-ttu-id="3131e-397">これは必須のパラメーターではありません。</span><span class="sxs-lookup"><span data-stu-id="3131e-397">This is not a required parameter.</span></span> <span data-ttu-id="3131e-398">UserName パラメーターが指定されていない場合は、現在のログオンユーザー名が接続に使用されます。</span><span class="sxs-lookup"><span data-stu-id="3131e-398">If no UserName parameter is specified then the current log on user name is used for the connection.</span></span>

<span data-ttu-id="3131e-399">このパラメーターは、PowerShell 6.0 で導入されました。</span><span class="sxs-lookup"><span data-stu-id="3131e-399">This parameter was introduced in PowerShell 6.0.</span></span>
...
### <span data-ttu-id="3131e-400">-SSHConnection</span><span class="sxs-lookup"><span data-stu-id="3131e-400">-SSHConnection</span></span>

<span data-ttu-id="3131e-401">このパラメーターは、ハッシュテーブルの配列を受け取ります。各ハッシュテーブルには、Secure Shell (SSH) 接続を確立するために必要な1つ以上の接続パラメーター (HostName、Port、UserName、KeyFilePath、サブシステム) が含まれています。</span><span class="sxs-lookup"><span data-stu-id="3131e-401">This parameter takes an array of hashtables where each hashtable contains one or more connection parameters needed to establish a Secure Shell (SSH) connection (HostName, Port, UserName, KeyFilePath, Subsystem).</span></span>

<span data-ttu-id="3131e-402">ハッシュテーブルの接続パラメーターは、 **HostName** パラメーターセットに対して定義されているものと同じです。</span><span class="sxs-lookup"><span data-stu-id="3131e-402">The hashtable connection parameters are the same as defined for the **HostName** parameter set.</span></span>
<span data-ttu-id="3131e-403">ハッシュテーブル内のキーの順序によって、最後に指定された接続で使用されているユーザー名とポートが使用されていることに注意してください。</span><span class="sxs-lookup"><span data-stu-id="3131e-403">Note that the order of the keys in the hashtable result in user name and port being used for the connection where the last one specified is used.</span></span>  <span data-ttu-id="3131e-404">たとえば、を使用すると、 `@{UserName="first";HostName="second@host"}` ユーザー名が使用され `second` ます。</span><span class="sxs-lookup"><span data-stu-id="3131e-404">For example, if you use `@{UserName="first";HostName="second@host"}`, then the user name `second` will be used.</span></span>  <span data-ttu-id="3131e-405">ただし、を使用する場合は、 `@{HostName="second@host:22";Port=23}` ポート23が使用されます。</span><span class="sxs-lookup"><span data-stu-id="3131e-405">However, if you use `@{HostName="second@host:22";Port=23}`, then port 23 will be used.</span></span>

<span data-ttu-id="3131e-406">このパラメーターは、PowerShell 6.0 で導入されました。</span><span class="sxs-lookup"><span data-stu-id="3131e-406">This parameter was introduced in PowerShell 6.0.</span></span>

<span data-ttu-id="3131e-407">**SSHConnection** パラメーターは、各セッションが異なる接続情報を必要とする複数のセッションを作成する場合に便利です。</span><span class="sxs-lookup"><span data-stu-id="3131e-407">The **SSHConnection** parameter is useful for creating multiple sessions where each session requires different connection information.</span></span>
...
### <span data-ttu-id="3131e-408">-サブシステム</span><span class="sxs-lookup"><span data-stu-id="3131e-408">-Subsystem</span></span>

<span data-ttu-id="3131e-409">新しい **PSSession** に使用する SSH サブシステムを指定します。</span><span class="sxs-lookup"><span data-stu-id="3131e-409">Specifies the SSH subsystem used for the new **PSSession**.</span></span>

<span data-ttu-id="3131e-410">これは sshd_config で定義されているターゲットで使用するサブシステムを指定します。</span><span class="sxs-lookup"><span data-stu-id="3131e-410">This specifies the subsystem to use on the target as defined in sshd_config.</span></span>
<span data-ttu-id="3131e-411">サブシステムは、定義済みのパラメーターを使用して特定のバージョンの PowerShell を起動します。</span><span class="sxs-lookup"><span data-stu-id="3131e-411">The subsystem starts a specific version of PowerShell with predefined parameters.</span></span>
<span data-ttu-id="3131e-412">指定したサブシステムがリモートコンピューターに存在しない場合、コマンドは失敗します。</span><span class="sxs-lookup"><span data-stu-id="3131e-412">If the specified subsystem does not exist on the remote computer, the command fails.</span></span>

<span data-ttu-id="3131e-413">このパラメーターを使用しない場合、既定値は ' powershell ' サブシステムになります。</span><span class="sxs-lookup"><span data-stu-id="3131e-413">If this parameter is not used, the default is the 'powershell' subsystem.</span></span>
...
### <span data-ttu-id="3131e-414">共通パラメーター</span><span class="sxs-lookup"><span data-stu-id="3131e-414">CommonParameters</span></span>

<span data-ttu-id="3131e-415">このコマンドレットは、一般的なパラメーターをサポートしています。-Debug、-ErrorAction、-ErrorVariable、-InformationAction、-InformationVariable、-OutVariable、-OutBuffer、-PipelineVariable、-Verbose、-WarningAction、-WarningVariable です。</span><span class="sxs-lookup"><span data-stu-id="3131e-415">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="3131e-416">詳細については、「about_CommonParameters」 (https://go.microsoft.com/fwlink/?LinkID=113216) ) を参照してください。</span><span class="sxs-lookup"><span data-stu-id="3131e-416">For more information, see about_CommonParameters (https://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="3131e-417">入力</span><span class="sxs-lookup"><span data-stu-id="3131e-417">INPUTS</span></span>

### <span data-ttu-id="3131e-418">System.string、System.string、system......。</span><span class="sxs-lookup"><span data-stu-id="3131e-418">System.String, System.URI, System.Management.Automation.Runspaces.PSSession</span></span>

<span data-ttu-id="3131e-419">パイプを使用して、文字列、URI、またはセッションオブジェクトをこのコマンドレットに送ることができます。</span><span class="sxs-lookup"><span data-stu-id="3131e-419">You can pipe a string, URI, or session object to this cmdlet.</span></span>

## <span data-ttu-id="3131e-420">出力</span><span class="sxs-lookup"><span data-stu-id="3131e-420">OUTPUTS</span></span>

### <span data-ttu-id="3131e-421">システム管理. 実行空間</span><span class="sxs-lookup"><span data-stu-id="3131e-421">System.Management.Automation.Runspaces.PSSession</span></span>

## <span data-ttu-id="3131e-422">注</span><span class="sxs-lookup"><span data-stu-id="3131e-422">NOTES</span></span>

- <span data-ttu-id="3131e-423">このコマンドレットは、PowerShell リモート処理インフラストラクチャを使用します。</span><span class="sxs-lookup"><span data-stu-id="3131e-423">This cmdlet uses the PowerShell remoting infrastructure.</span></span> <span data-ttu-id="3131e-424">このコマンドレットを使用するには、ローカルコンピューターとリモートコンピューターを PowerShell リモート処理用に構成する必要があります。</span><span class="sxs-lookup"><span data-stu-id="3131e-424">To use this cmdlet, the local computer and any remote computers must be configured for PowerShell remoting.</span></span> <span data-ttu-id="3131e-425">詳細については、「[about_Remote_Requirements](About/about_Remote_Requirements.md)」を参照してください。</span><span class="sxs-lookup"><span data-stu-id="3131e-425">For more information, see [about_Remote_Requirements](About/about_Remote_Requirements.md).</span></span>
- <span data-ttu-id="3131e-426">ローカルコンピューター上に **PSSession** を作成するには、[管理者として実行] オプションを使用して PowerShell を起動します。</span><span class="sxs-lookup"><span data-stu-id="3131e-426">To create a **PSSession** on the local computer, start PowerShell with the Run as administrator option.</span></span>
- <span data-ttu-id="3131e-427">**Pssession** が終了したら、コマンドレットを使用して `Remove-PSSession` **pssession** を削除し、そのリソースを解放します。</span><span class="sxs-lookup"><span data-stu-id="3131e-427">When you are finished with the **PSSession** , use the `Remove-PSSession` cmdlet to delete the **PSSession** and release its resources.</span></span>
- <span data-ttu-id="3131e-428">**ホスト名** と **SSHConnection** パラメーターセットは、PowerShell 6.0 以降に含まれていました。</span><span class="sxs-lookup"><span data-stu-id="3131e-428">The **HostName** and **SSHConnection** parameter sets were included starting with PowerShell 6.0.</span></span>
  <span data-ttu-id="3131e-429">これらは、Secure Shell (SSH) に基づいて PowerShell リモート処理を提供するために追加されました。</span><span class="sxs-lookup"><span data-stu-id="3131e-429">They were added to provide PowerShell remoting based on Secure Shell (SSH).</span></span> <span data-ttu-id="3131e-430">複数のプラットフォーム (Windows、Linux、macOS) では SSH と PowerShell の両方がサポートされており、powershell リモート処理は PowerShell と SSH がインストールおよび構成されているこれらのプラットフォーム上で機能します。</span><span class="sxs-lookup"><span data-stu-id="3131e-430">Both SSH and PowerShell are supported on multiple platforms (Windows, Linux, macOS) and PowerShell remoting will work over these platforms where PowerShell and SSH are installed and configured.</span></span> <span data-ttu-id="3131e-431">これは、WinRM に基づく以前の Windows のみのリモート処理とは別のものであり、WinRM 固有の機能の多くは適用されません。</span><span class="sxs-lookup"><span data-stu-id="3131e-431">This is separate from the previous Windows only remoting that is based on WinRM and much of the WinRM specific features and limitations do not apply.</span></span> <span data-ttu-id="3131e-432">たとえば、WinRM ベースのクォータ、セッションオプション、カスタムエンドポイントの構成、および切断/再接続機能は現在サポートされていません。</span><span class="sxs-lookup"><span data-stu-id="3131e-432">For example WinRM based quotas, session options, custom endpoint configuration, and disconnect/reconnect features are currently not supported.</span></span> <span data-ttu-id="3131e-433">PowerShell SSH リモート処理の設定方法の詳細については、「 [Ssh 経由の Powershell リモート](/powershell/scripting/learn/remoting/ssh-remoting-in-powershell-core)処理」を参照してください。</span><span class="sxs-lookup"><span data-stu-id="3131e-433">For more information about how to set up PowerShell SSH remoting, see [PowerShell Remoting Over SSH](/powershell/scripting/learn/remoting/ssh-remoting-in-powershell-core).</span></span>

## <span data-ttu-id="3131e-434">関連リンク</span><span class="sxs-lookup"><span data-stu-id="3131e-434">RELATED LINKS</span></span>

[<span data-ttu-id="3131e-435">Connect-PSSession</span><span class="sxs-lookup"><span data-stu-id="3131e-435">Connect-PSSession</span></span>](Connect-PSSession.md)

[<span data-ttu-id="3131e-436">Disconnect-PSSession</span><span class="sxs-lookup"><span data-stu-id="3131e-436">Disconnect-PSSession</span></span>](Disconnect-PSSession.md)

[<span data-ttu-id="3131e-437">Enter-PSSession</span><span class="sxs-lookup"><span data-stu-id="3131e-437">Enter-PSSession</span></span>](Enter-PSSession.md)

[<span data-ttu-id="3131e-438">Exit-PSSession</span><span class="sxs-lookup"><span data-stu-id="3131e-438">Exit-PSSession</span></span>](Exit-PSSession.md)

[<span data-ttu-id="3131e-439">Get-PSSession</span><span class="sxs-lookup"><span data-stu-id="3131e-439">Get-PSSession</span></span>](Get-PSSession.md)

[<span data-ttu-id="3131e-440">Invoke-Command</span><span class="sxs-lookup"><span data-stu-id="3131e-440">Invoke-Command</span></span>](Invoke-Command.md)

[<span data-ttu-id="3131e-441">Receive-PSSession</span><span class="sxs-lookup"><span data-stu-id="3131e-441">Receive-PSSession</span></span>](Receive-PSSession.md)

[<span data-ttu-id="3131e-442">Remove-PSSession</span><span class="sxs-lookup"><span data-stu-id="3131e-442">Remove-PSSession</span></span>](Remove-PSSession.md)
