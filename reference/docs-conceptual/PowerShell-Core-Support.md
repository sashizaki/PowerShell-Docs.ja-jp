# <a name="powershell-core-support-lifecycle"></a><span data-ttu-id="41b0b-101">PowerShell Core のサポート ライフサイクル</span><span class="sxs-lookup"><span data-stu-id="41b0b-101">PowerShell Core Support Lifecycle</span></span>
