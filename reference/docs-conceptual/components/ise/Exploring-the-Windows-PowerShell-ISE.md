...
## <a name="status-bar"></a><span data-ttu-id="7a1c4-170">ステータス バー</span><span class="sxs-lookup"><span data-stu-id="7a1c4-170">Status Bar</span></span>
