...
1. [Windows PowerShell Web Access をインストールする]()
2. [ゲートウェイを構成する]()
3. [承認規則を構成する]()
...
### <a name="install-windows-powershell-web-access"></a>Windows PowerShell Web Access をインストールする
...
- [IPsec の展開リソース](https://technet.microsoft.com/network/bb531150)
