...
3. <span data-ttu-id="dae5b-111">**[ビルド]** メニューの **[ソリューションのビルド]** をクリックします。</span><span class="sxs-lookup"><span data-stu-id="dae5b-111">In the **Build** menu, select **Build Solution**.</span></span>
