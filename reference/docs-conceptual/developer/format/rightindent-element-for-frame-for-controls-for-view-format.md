...
Configuration 要素 (Format) ViewDefinitions 要素 (書式) ビュー要素 (書式) コントロールの要素 (書式) コントロールのコントロール要素を表示するためのコントロール (format) の CustomControl 要素のコントロール要素CustomControl for view (format) CustomEntry 要素は、ビュー (形式) の customentries 要素をコントロールのためのコントロールのために、ビュー (書式) 用の Customentries 要素のコントロールに対して、ビュー (書式) を設定するために使用します。ビューのコントロール (書式)
