...
ms.date: 09/13/2016
ms.topic: reference
title: GetProc05 (VB.NET) サンプル コード
description: GetProc05 (VB.NET) サンプル コード
ms.openlocfilehash: 6860a8276fd691562ae7e2cbbd95d199ee93fd71
ms.sourcegitcommit: ba7315a496986451cfc1296b659d73ea2373d3f0
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 12/10/2020
ms.locfileid: "92653869"
---
# <a name="getproc05-vbnet-sample-code"></a><span data-ttu-id="9580b-103">GetProc05 (VB.NET) サンプル コード</span><span class="sxs-lookup"><span data-stu-id="9580b-103">GetProc05 (VB.NET) Sample Code</span></span>

<span data-ttu-id="9580b-104">GetProc05 sample コマンドレットの完全な VB.NET コードを次に示します。</span><span class="sxs-lookup"><span data-stu-id="9580b-104">Here is the complete VB.NET code for the GetProc05 sample cmdlet.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="9580b-105">参照</span><span class="sxs-lookup"><span data-stu-id="9580b-105">See Also</span></span>

[<span data-ttu-id="9580b-106">Windows PowerShell SDK</span><span class="sxs-lookup"><span data-stu-id="9580b-106">Windows PowerShell SDK</span></span>](../windows-powershell-reference.md)
