...
Ubuntu 20.04 は LTS リリースです。 現在、PowerShell はこのバージョンをサポートしていません。 このバージョンのサポートは、PowerShell 7.1 リリースで考慮されています。 Ubuntu 20.04 のサポートを希望する場合は、この[要求](https://github.com/PowerShell/PowerShell/issues/12626)にご投票ください。
