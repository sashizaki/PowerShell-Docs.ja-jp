...
## <a name="using-jea-with-powershell-direct"></a><span data-ttu-id="9c70a-148">PowerShell Direct での JEA の使用</span><span class="sxs-lookup"><span data-stu-id="9c70a-148">Using JEA with PowerShell Direct</span></span>
