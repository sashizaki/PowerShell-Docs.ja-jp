...
列挙値は **.NET Framework** でドキュメント化されています。 詳細については、[StandardEventKeywords 列挙型](/dotnet/api/system.diagnostics.eventing.reader.standardeventkeywords)に関するページをご覧ください。
...
列挙値は **.NET Framework** でドキュメント化されています。 詳細については、[StandardEventLevel 列挙型](/dotnet/api/system.diagnostics.eventing.reader.standardeventlevel)に関するページをご覧ください。
