...
この記事では、PowerShell のさまざまなバージョンに付属するモジュールとコマンドレットの一覧を示します。 これは、リリース ノートに記載されている情報のまとめです。 詳細については、リリース ノートを参照してください。

- [PowerShell Core 6.2 の新機能](what-s-new-in-powershell-core-62.md)
- [PowerShell Core 6.1 の新機能](what-s-new-in-powershell-core-61.md)
- [PowerShell Core 6.0 の新機能](what-s-new-in-powershell-core-60.md)
- [PowerShell Core 6.0 の破壊的変更](breaking-changes-ps6.md)
- [PowerShell Core 6.0 の既知の問題](known-issues-ps6.md)
...
| Stop-Computer                 | &check; | &check; | &check; | &check; | 7\.0 で Linux/macOS サポートが追加されました |
...
| Get-CmsMessage            | &check; | &check; | &check; | &check; | Windows のみ                            |
...
| Protect-CmsMessage        | &check; | &check; | &check; | &check; | Windows のみ                            |
...
| Unprotect-CmsMessage      | &check; | &check; | &check; | &check; | Windows のみ                            |
