...
このトピックでは、[!INCLUDE[ise_1](../Token/ise_1_md.md)] のビジュアル デバッグ機能を使ってローカル コンピューター上でスクリプトをデバッグする方法について説明します。
...
この 3 種類のうち、行のブレークポイントだけは、[!INCLUDE[ise_2](../Token/ise_2_md.md)] デバッグ環境で、メニューやキーボード ショートカットを使って設定できます。 他の 2 つの種類のブレークポイントは、コンソール ウィンドウから [Set-PSBreakpoint [m2]](https://technet.microsoft.com/en-us/library/88d2d9ad-17dc-44ae-99aa-f841125b9dc8) コマンドレットを使って設定できます。 このセクションでは、[!INCLUDE[ise_2](../Token/ise_2_md.md)] でメニューが使用可能な場合は使用してデバッグ作業を実行する方法と、スクリプトを使用してさまざまなコマンドをコンソール ウィンドウから実行する方法を説明します。
...
### すべてのブレークポイントの一覧を表示
現在の [!INCLUDE[wps_1](../Token/wps_1_md.md)] セッションで設定されているすべてのブレークポイントを表示します。
