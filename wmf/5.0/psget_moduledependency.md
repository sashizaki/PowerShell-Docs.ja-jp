...
---
# <a name="installation-of-module-dependencies"></a><span data-ttu-id="da43b-102">モジュールの依存関係のインストール</span><span class="sxs-lookup"><span data-stu-id="da43b-102">Installation of Module Dependencies</span></span>

<span data-ttu-id="da43b-103">Windows PowerShell 5.0 以降で実行される Install-Module、Update-Module、および Publish-Module コマンドレットには、Side-by-Side (SxS) モジュール バージョン サポートがあります。</span><span class="sxs-lookup"><span data-stu-id="da43b-103">There is now side-by-side (SxS) module version support in Install-Module, Update-Module, and Publish-Module cmdlets that run in Windows PowerShell 5.0 or newer.</span></span>
<span data-ttu-id="da43b-104">また、発行するバージョンを指定する -RequiredVersion パラメーターを Publish-Module コマンドレットに追加しました。</span><span class="sxs-lookup"><span data-stu-id="da43b-104">Also, we have added a -RequiredVersion parameter to the Publish-Module cmdlet to specify the version to be published.</span></span> <span data-ttu-id="da43b-105">Path パラメーターは、モジュールのベース パスと、バージョン フォルダーをサポートするようになりました。</span><span class="sxs-lookup"><span data-stu-id="da43b-105">The Path parameter now supports the module base path with the version folder.</span></span>

<span data-ttu-id="da43b-106">**Install-Module の例:**</span><span class="sxs-lookup"><span data-stu-id="da43b-106">**Install-Module examples:**</span></span>
```powershell
...
<span data-ttu-id="da43b-107">**依存関係があるモジュールのインストール:**</span><span class="sxs-lookup"><span data-stu-id="da43b-107">**Install a module with dependencies:**</span></span>
```powershell
PS C:\\windows\\system32&gt; Get-InstalledModule
...
<span data-ttu-id="da43b-108">**ModuleWithDependencies2 モジュール マニフェスト ファイルの内容**</span><span class="sxs-lookup"><span data-stu-id="da43b-108">**Contents of ModuleWithDependencies2 module manifest file:**</span></span>
```powershell
@{
...
<span data-ttu-id="da43b-109">**Update-Module の例:**</span><span class="sxs-lookup"><span data-stu-id="da43b-109">**Update-Module examples:**</span></span>
```powershell
...
<span data-ttu-id="da43b-110">**Publish-Module の例:**</span><span class="sxs-lookup"><span data-stu-id="da43b-110">**Publish-Module examples:**</span></span>
```powershell
